    ...
    <section className="py-16 lg:py-32 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Card Missão */}
          <div className="group flex flex-col items-center text-center p-8 rounded-2xl bg-card hover:bg-card/80 border border-border hover:border-primary/20 transition-all duration-300 hover:transform hover:-translate-y-2">
          ...
          <div className="group flex flex-col items-center text-center p-8 rounded-2xl bg-card hover:bg-card/80 border border-border hover:border-primary/20 transition-all duration-300 hover:transform hover:-translate-y-2">
            <div className="bg-primary/10 p-5 rounded-2xl mb-6 group-hover:bg-primary/20 transition-colors">
              <View className="h-10 w-10 text-primary" />
            </div>
            <h3 className="text-2xl font-bold mb-4 text-foreground group-hover:text-primary transition-colors">
              Visão
            </h3>
